...
python3 ./tools/test_npu.py ./configs/fcos/fcos_r50_caffe_fpn_4x4_1x_coco.py ./work_dirs/fcos_r50_caffe_fpn_4x4_1x_coco/latest.pth --out ${test_path_dir}/output/$ASCEND_DEVICE_ID   --eval bbox  --launcher pytorch
